...
<html lang="es">
<head>
    <title>Escuela Normal Superior de Querétaro</title>
    <meta charset="utf-8">
    <meta name="author" content="Efren_RZ">
    <meta name="description" content="Escuela Normal Superior de Querétaro"/>
...
<div class="container">
    <div class="text-right" >
        Tels. (442) 214-4941; 214-4741 <a href="mailto:contacto@ensq.edu.mx">contacto@ensq.edu.mx</a>
    </div>
</div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-header">Diplomados</li>
                            <li><a href="#">Compentencias Comunitativas</a></li>
                            <li><a href="#">Compentencias Didácticas</a></li>
                            <li><a href="#">Compentencias para el Inglés</a></li>
                            <li><a href="#">Enseñanza de la Matemáticas</a></li>
                            <li role="separator" class="divider"></li>
                            <li class="dropdown-header">Curso</li>
                            <li><a href="#">Desarrollo de Habilidades Intelecuales a traves del ensayo</a></li>
                        </ul>
                    </li>
